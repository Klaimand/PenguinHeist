...
public class Awareness : MonoBehaviour
{
    ...
    [Header("Draw View Visualition")]
    [Tooltip("Mesh resolution of the AI")]
    [SerializeField] float meshResolution = 1;
    [Tooltip("Edge resolve iterations of the AI")]
    [SerializeField] int edgeResolveIterations;
    [Tooltip("Edge distance threshold of the AI")]
